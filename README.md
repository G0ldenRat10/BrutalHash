...
## Youtube Tutorial: [LINK](https://www.youtube.com/watch?v=qUqQG65M328)
...
### Platform notes
- Works out of the box on Linux, macOS, and Windows (no shell-specific dependencies).
